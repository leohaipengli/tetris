...
SOURCE= tetris.cpp include/InitShader.cpp include/controller.cpp
...
# TODO: remove -ggdb after finish change O0 to O3
CFLAGS= -O0 -std=c++11 -g -Wall -pedantic -DGL_GLEXT_PROTOTYPES -ggdb
